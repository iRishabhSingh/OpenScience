  ...
  return (
    <div class="overflow-auto">
      <div className="bg-gradient-to-b from-[#B7EFFB] to-white flex flex-col pl-5 pr-5">
            ...
            <div class="flex w-1/2 flex-wrap absolute-right-0">
              <div>
                <h1 className="text-2xl font-bold dark:text-white left-9 ml-5">
                  Project title: "Global Climate Observations Initiative(GCOI)"
                </h1>
                <br />
                ...
                <div class="flex w-2/3">
                  <input
                    type="text"
                    id="first_name"
                    class="bg-gray-200 border border-gray-300 text-gray-700 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <div>
          <h2 class="text-xl font-bold dark:text-white left-9 ml-5">
            Project Description
          </h2>
          <p class="font-medium text-sm pt-5 text-justify ml-8 mr-10">
            The "Global Climate Observations Initiative (GCOI)" is a pioneering
            open science project dedicated to monitoring, understanding, and
            mitigating the impact of climate change on a global scale. With a
            community of scientists, researchers, and concerned citizens from
            around the world, GCOI exemplifies the principles of open science,
            collaboration, and data sharing to address one of the most pressing
        ...
        <div>
          <a
            href="#_"
            class="ml-8 relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-indigo-600 border-2 border-indigo-600 rounded-full hover:text-white group hover:bg-gray-50"
          >
            ...
            <span class="relative ml-8">Looking For Collaborator</span>
          </a>
        </div>
        <div>
          <h2 class="text-xl font-bold dark:text-white left-9 ml-5 mt-6">
            ...
            <div class="ml-8 mr-10 mt-5 mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
              <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                ...
                <textarea
                  id="comment"
                  rows="4"
                  class="ml-8 w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
              ...
              <div class="flex items-center justify-between px-3 py-2 border-t dark:border-gray-600">
                <button
                  type="submit"
                  class="ml-8 inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800"
                >
                  Apply
                </button>
              </div>
        ...
        <div>
          ...
          <p class="text-xl font-semibold leading-6 text-gray-900 ml-8 mr-10">
            Created By:
          </p>
          <br />
          <div class="grid grid-cols-2 divide-x">
            <div className="mr-10">
              <div class="flex min-w-0 gap-x-4 mr-8 ">
                <img
            ...
            <div>
              ...
              <label
                for="message"
                class="text-lg font-semibold leading-6 text-gray-900 absolute-right-0 block mb-2  dark:text-white"
              >
                Give Feedback:
              </label>
        ...
        <div className="flex mt-4">
          <div class=" ml-8 block max-w-[18rem] rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">

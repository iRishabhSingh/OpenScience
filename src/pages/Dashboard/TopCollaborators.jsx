const TopCollaborators = () => {
  return (
    <div className="p-10">
      <h1 className="font-bold text-3xl tracking-widest">Top Collaborators</h1>
        ...
        {[1, 2, 3, 4, 5, 6, 7].map((val, index) => {
          return (
            ...
            >
              ...
              />
              <div>
                <h3 className="font-semibold text-lg">Mrinmoy Saikia</h3>
                <p className="flex">
                  {" "}
                  <svg
